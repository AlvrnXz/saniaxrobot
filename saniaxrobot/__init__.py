...
def get_user_list(__init__, key):
    with open("{}/saniaxrobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]


# enable logging
FORMAT = "[saniaxrobot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger("[saniaxrobot]")
...
if ENV:
    ...
    from saniaxrobot.config import Development as Config
...
from saniaxrobot.modules.helper_funcs.handlers import (
