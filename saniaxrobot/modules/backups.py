...
import saniaxrobot.modules.sql.notes_sql as sql
from saniaxrobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from saniaxrobot.__main__ import DATA_IMPORT
from saniaxrobot.modules.helper_funcs.chat_status import user_admin
from saniaxrobot.modules.helper_funcs.alternate import typing_action

# from saniaxrobot.modules.rules import get_rules
import saniaxrobot.modules.sql.rules_sql as rulessql

# from saniaxrobot.modules.sql import warns_sql as warnssql
import saniaxrobot.modules.sql.blacklist_sql as blacklistsql
from saniaxrobot.modules.sql import disable_sql as disabledsql

# from saniaxrobot.modules.sql import cust_filters_sql as filtersql
# import saniaxrobot.modules.sql.welcome_sql as welcsql
import saniaxrobot.modules.sql.locks_sql as locksql
from saniaxrobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("saniaxrobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("saniaxrobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `saniaxrobot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("saniaxrobot{}.backup".format(chat_id))  # Cleaning file
